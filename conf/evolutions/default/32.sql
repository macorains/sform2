...
CREATE TABLE D_TRANSFER_CONFIG_SALESFORCE_OBJECT (
  ...
  PRIMARY KEY (ID),
  INDEX IDX_TRANSFER_CONFIG_SALESFORCE_ID (TRANSFER_CONFIG_SALESFORCE_ID ASC) VISIBLE);
...
CREATE TABLE D_TRANSFER_CONFIG_SALESFORCE_OBJECT_FIELD (
  ...
  MODIFIED DATETIME NOT NULL,
  PRIMARY KEY (ID),
  INDEX IDX_TRANSFER_CONFIG_SALESFORCE_OBJECT_ID (TRANSFER_CONFIG_SALESFORCE_FIELD_ID ASC) INVISIBLE);

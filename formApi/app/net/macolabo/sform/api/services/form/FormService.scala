package net.macolabo.sform.api.services.form

import akka.actor.ActorRef
import com.google.inject.Inject
import net.macolabo.sform.api.models.daos.{FormColDAO, FormColSelectDAO, FormColValidationDAO, FormDAO, PostdataDAO}
import net.macolabo.sform.api.models.form.{Form, FormCol, FormColSelect}
import net.macolabo.sform.api.services.transfer.TransferReceiver.NewTaskRequest
import net.macolabo.sform.api.utils.forms.{FormColType_Checkbox, FormColType_Combo, FormColType_DisplayText, FormColType_Hidden, FormColType_Radio, FormColType_Text, FormColType_TextArea}
